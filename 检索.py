...
# Paths to the data files (using relative paths)
        ...
        if selected_level2_display != '请选择':
            ...
            if 'E' in df.columns and not df_level2['E'].dropna().empty:
                ...
                if selected_level3_display != '请选择':
                    ...
                    header_html = f"<h3 style='font-size: 1.2em;'>{selected_level1} - {selected_level1_text}  {selected_level2} - {selected_level2_text}  {selected_level3}</h3>"
